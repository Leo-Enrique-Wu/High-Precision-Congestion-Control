...
public:
  ...
  // leo start
  inline uint64_t GetSendingTime (void) const;
  inline void SetSendingTime (uint64_t in_sendingTime);
  // leo end
...
// leo start
uint64_t
Packet::GetSendingTime (void) const
{
	return sendingTime;
}

void 
Packet::SetSendingTime (uint64_t in_sendingTime)
{
	sendingTime = in_sendingTime;
}
// leo end
